...
class CodiaPage extends StatefulWidget {
  final group2ModelList = [
    ...
    GroupCell1Model(
      section: 0,
      cellType: 'GroupCell1Item',
      textNitrogenStatus: 'Potassium status',
      customTextLabel: 'Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum ',
      customTextLabel1: 'Today at 9:42 AM',
      customTextLabel1: 'Addis Abeba',
    ),
    GroupCell1Model(
      section: 0,
      cellType: 'GroupCell1Item',
      textNitrogenStatus: 'Phosphorous status',
      customTextLabel: 'Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum ',
      customTextLabel1: 'Today at 9:42 AM',
      customTextLabel1: 'Addis Abeba',
    ),
    GroupCell1Model(
      section: 0,
      cellType: 'GroupCell1Item',
      textNitrogenStatus: 'Humidity status',
      customTextLabel: 'Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum ',
      customTextLabel1: 'Today at 9:42 AM',
      customTextLabel1: 'Addis Abeba',
    ),
                                                                  ...
                                                                  child: Stack(
                                                                    children: [
                                                                      ...
                                                                      Positioned(
                                                                        ...
                                                                        top: 47,
                                                                        height: 15.414,
                                                                        child: Image.asset('images/imageVector_129251.png', width: 18.414, height: 15.414,),
                                                                      ),
                                                                    ],
                                                                  ),
                                                                ),
                                                                                            ...
                                                                                            child: Column(
                                                                                              ...
                                                                                              children: [
                                                                                                Row(
                                                                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                                                                  children: [
                                                                                                    Image.asset('images/image_129293.png', width: 130, height: 134, fit: BoxFit.cover,),
                                                                                                  ],
                                                                                                ),
                                ...
                                Expanded(
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Container(
                                          child: Image.asset('images/imageGroup_129473.png', height: 64,),
                                        ),
                                      ),
                                    ],
                                  ),
