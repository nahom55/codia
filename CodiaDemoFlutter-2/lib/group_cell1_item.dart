                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: Container(
                                                              child: Text(
                                                                widget.model.textNitrogenStatus,
                                                                            ...
                                                                            child: Column(
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  width: double.infinity,
                                                                                  child: Text(
                                                                                    widget.model.textLabelLocation,
                                                                                    textAlign: TextAlign.left,
                                                                                    style: TextStyle(decoration: TextDecoration.none, fontSize: 7, color: const Color(0xffa5acb8), fontFamily: 'Inter-Medium', fontWeight: FontWeight.normal),
                                                                                    maxLines: 9999,
                                                                                    overflow: TextOverflow.ellipsis,
...
class GroupCell1Model {
  int section;
  String cellType;
  String textNitrogenStatus;
  String customTextLabel;
  String textLabelTime;
  String textLabelLocation;

  GroupCell1Model({
    this.section = 0,
    this.cellType = '',
    this.textNitrogenStatus = '',
    this.customTextLabel = '',
    this.textLabelTime = '',
    this.textLabelLocation = ''
  });
}
